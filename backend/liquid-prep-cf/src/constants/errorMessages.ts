export class ErrorMessages {
    ...
    // GENERIC ERRORS
    public static GENERIC_ERROR_MESSAGE: string = "Something went wrong querying data."

    // API KEYS
    public static IAM_API_KEY_UNDEFINED: string = "IBM Cloud IAM API key is undefined or null."
